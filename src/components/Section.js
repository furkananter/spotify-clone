            ...
            <div className="grid grid-cols-5 gap-x-6">
                {items.map(item => (
                    ...
                    <div className="pt-[100%] relative mb-4 ">
                        ...
                        <button
                            className="transition-button bg-primary w-10 h-10 rounded-full absolute bottom-2 group-hover:flex group-focus:flex right-2 items-center justify-center hidden">
