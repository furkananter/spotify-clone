    ...
    >
        <div className="pt-[100%] relative mb-4 duration-700">
            ...
            <button
                ...
                className={`w-12 h-12 rounded-full shadow-md hover:scale-105 bg-primary text-black absolute group-hover:flex group-focus:flex bottom-2 right-2 items-center justify-center ${!isCurrentItem ? 'hidden' : 'flex'}`}>
